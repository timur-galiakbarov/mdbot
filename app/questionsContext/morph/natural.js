var naturalModule = require('natural'),
    ...
    tokenizer = new naturalModule.WordTokenizer(naturalModule.PorterStemmerRu),
...
var natural = (function(){
    ...
    var api = {
        tokenizer: function (message) {
            naturalModule.PorterStemmerRu.attach();
            var wordArr = [];
            wordArr = message.toLowerCase().tokenizeAndStem();
            console.log(wordArr);
            return wordArr;
        }
    };
